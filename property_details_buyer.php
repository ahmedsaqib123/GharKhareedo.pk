                ...
                <div class="nav_w3ls ml-lg-5">
                    <nav>
                        ...
                        <ul class="menu">
                            ...
                            <li></li>
                            <li><a href="includes/AllProperty.php" style="font-family: 'Poppins';">Find a Property</a></li>
                            <li>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="product_meta">
                            ...
                            <button class="btn btn-round btn-danger" type="button"
                                style="background-color: #343a40; color: white;"><i class="fa fa-info"
                                    aria-hidden="true" style="margin-right: 10px;"></i>
                                <a href="#popup1" style="color: white;">Contact Details</a></button>
                                
                            <button class="btn btn-round btn-danger" type="button"
                                style="background-color: #343a40; color: white;">
                                <i class="fa fa-heart" style="height: 20px;"></i>
                                <a href="includes/favourites.php?id=<?php echo $rows1['Property_id'] ?>" style="color: white;">Add To Favourites</a></button>
                        </div>
                    </div>
                    <?php 
                        }
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="product_meta">
                            ...
                            <button class="btn btn-round btn-danger" type="button"
                                style="background-color: #343a40; color: white;">
                                <i class="fa fa-heart" style="height: 20px;"></i>
                                <a href="includes/favourites.php?id=<?php echo $rows2['Property_id'] ?>" style="color: white;">Add To Favourites</a></button>
                        </div>
                    </div>
                    <?php
                        }
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="product_meta">
                            ...
                            <button class="btn btn-round btn-danger" type="button"
                                style="background-color: #343a40; color: white;">
                                <i class="fa fa-heart" style="height: 20px;"></i>
                                <a href="includes/favourites.php?id=<?php echo $rows3['Property_id'] ?>" style="color: white;">Add To Favourites</a></button>
                        </div>
                    </div>
                    <?php } ?>
                </div>
        ...
        <div class="container py-xl-4 py-lg-3">
            <div class="row footer-grids">
                ...
                <div class="col-3 footer-grid">
                    ...
                    <ul class="list-unstyled">
                        <li>
                            <a href="includes/AllProperty.php" style="color: black;">Find a Property</a>
                        </li>
                        <li>
