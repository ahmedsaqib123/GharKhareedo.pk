...
<body>
    ...
    <div class="main-w3pvt mian-content-wthree text-center" id="home">
        <div class="container" style="font-family: 'Poppins';">
            <div class="style-banner mx-auto">
                <h3 class="text-wh font-weight-bold" style="color: white;" style="font-family: 'Poppins';">Add Your <span style="color: black;">Luxury</span>
                    <br/> Homes For Sale</h3>
                    <br/>
                <p class="mt-2 text-li" id="find" style="color: white;">Property for sale around the world</p>
                <!-- form -->
                <div class="home-form-w3ls mt-5 pt-lg-4">
                        <button type="submit" class="btn btn_apt" style="background-color: #343a40;">
                        <a href="./AddProperty.php" style="color: white;">Add Property</a></button>
                </div>
                <!-- //form -->
            </div>
        </div>
    ...
    <section class="branches py-5" id="places" style="background-color: white; color: #343a40;">
        <div class="container py-xl-5 py-lg-3">
            <h3 class="title-w3 mb-2 text-center text-bl font-weight-bold" style="color: #343a40;" style="font-family: 'Poppins';">Most Popular Places</h3>
            <p class="text-center title-w3 mb-md-5 mb-4" style="color: #343a40;" style="font-family: 'Poppins';">Colorful places to live and play.
            </p>
            <div class="row branches-position pt-4">
                <div class="col-lg-3 col-sm-6 place-w3">
                    <!-- branch-img -->
                    <div class="team-img team-img-1">
                        <div class="team-content" style="font-family: 'Poppins';">
                ...
                <div class="col-lg-3 col-sm-6 place-w3 mt-sm-0 mt-4">
                    <!-- team-img -->
                    <div class="team-img team-img-2" style="font-family: 'Poppins';">
    ...
    <div class="gallery pb-5" id="gallery" style="background-color: #343a40;">
        <div class="container py-xl-5 py-lg-3">
            <h3 class="title-w3 mb-2 text-center text-bl font-weight-bold" style="color: white;" style="font-family: 'Poppins';">Our Gallery</h3>
            <p class="text-center title-w3 mb-md-5 mb-4" style="color: white;" style="font-family: 'Poppins';">Colorful places to live and play.
            </p>
            ...
            <div id="gal1" class="pop-overlay animate">
                <div class="popup" style="font-family: 'Poppins';">
            ...
            <div id="gal5" class="pop-overlay animate">
                <div class="popup" sstyle="font-family: 'Poppins';">
    ...
    <footer class="py-5" style="background-color: #f7f7f7; color: black">
        <div class="container py-xl-4 py-lg-3">
            <div class="row footer-grids" style="font-family: 'Poppins';">
                ...
                <div class="col-3 footer-grid">
                    <div class="footer-logo">
                        <h2 class="text-lg-center text-center">
                            <a class="logo text-wh font-weight-bold" href="index_seller.php" style="margin-left: 30px;"><img src="./WhatsApp Image 2020-11-12 at 1.39.25 PM.jpeg"></a>
                        </h2>
                    </div>
                </div>
   ...
   <div class="copyright-w3ls py-4">
        <div class="container">
            <div class="row">
                <!-- copyright -->
                <p class="col-lg-8 copy-right-grids text-wh text-lg-left text-center mt-lg-2" style="font-family: 'Poppins';">© 2019 Ghar Khareedo.pk. All
                    Rights Reserved | Design by
                    <a href="#" target="_blank">SHAHEER AHMED SAROOSH</a>
                </p>
                <!-- //copyright -->
                <!-- social icons -->
                <div class="col-lg-4 w3social-icons text-lg-right text-center mt-lg-0 mt-3" style="font-family: 'Poppins';">
                    <ul>
                        <li>
