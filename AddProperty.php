...
<head>
    ...
    <script type="text/javascript">
        ...
        var subcategorys = {
            Homes: ["Ground", "1st", "2nd", "3rd", "4th", "5th", "6th"],
            Flat: [0, 1, 2, 3, 4, 5, 6]
        }

        var subcategoryss = {
            Homes: [1, 2, 3, 4, 5, 6, 7, 8],
            Flat: [1, 2, 3, 4, 5, 6]
        }
        ...
        function makeSubmenus(value) {
            ...
            if (value.length == 0) document.getElementById("categorySelectss").innerHTML = "<option></option>";
            else {
                var citiesOptions = "";
                for (categoryId in subcategoryss[value]) {
                    citiesOptions += "<option>" + subcategoryss[value][categoryId] + "</option>";
                }
                document.getElementById("categorySelectss").innerHTML = citiesOptions;
            }
        }

        function displaySelecteds() {
            var type = document.getElementById("categorys").value;
            var floor = document.getElementById("categorySelects").value;
            var rooms = document.getElementById("categorySelectss").value;
            alert(type + "\n" + floor + "\n" + rooms);
        }
        ...
        function resetSelections() {
            ...
            document.getElementById("categorySelectss").selectedIndex = 0;
        }
    </script>
...
<body class="form">
    ...
    <div class="inner-banner-w3lss">
        ...
        <div class=" container formeds" style="font-family: Poppins;">
            ...
            <br />
            <h6 class="heading-form">Enter Property Details</h6>
            <br />
                ...
                <div class="container Property-type">
                    ...
                    <div onload="resetSelections()">
                        <div class="row">
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    <select required="" id="categorys" size="1" onchange="makeSubmenus(this.value)" class="form-control" name="propertyType">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    <select id="categorySelects" size="1" class="form-control" name="manzil">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    <select id="categorySelectss" size="1" class="form-control" name="rooms">
