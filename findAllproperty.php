...
<body>
    ...
    <div class="main-w3pvt mian-content-wthrees text-center" id="home">
        <div class="container">
            <div class="style-banner mx-auto">
                <h3 class="text-wh font-weight-bold" style="color: white;font-family: 'Poppins';">Find Property Here
                </h3>
                <!-- form -->
    ...
    <!-- //header -->
    <br />
    <p id="idhar" style="font-family: 'Poppins';">home>find Properties</p>
    <hr />
        ...
        <div class="container py-xl-4 py-lg-3">
            <div class="row footer-grids">
                ...
                <div class="col-3 footer-grid">
                    ...
                    <ul class="list-unstyled">
                        <li>
                            <a href="findAllproperty.php" style="color: black;">Find a Property</a>
                        </li>
                        <li>
